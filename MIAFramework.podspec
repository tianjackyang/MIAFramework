#
#  Be sure to run `pod spec lint MIAFramework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/tianjackyang/MIAFramework.git", :tag => s.version, :submodules => true }
  ...
  s.source_files  = "Pod/SLMFramework.h"
  # s.exclude_files = "Classes/Exclude"

  s.public_header_files = "Pod/SLMFramework.h"
